...
There is currently no version of this project published to Maven or JCenter.
To use the DSL you have to refer to the repository http://dl.bintray.com/bobbytank42/maven and add a dependency on `org.asciidoctor:asciidoctorj-groovy-dsl:0.1-Alpha1`.
...
repositories {
    jcenter()
    maven {
        url "http://dl.bintray.com/bobbytank42/maven"
    }
}
dependencies {
